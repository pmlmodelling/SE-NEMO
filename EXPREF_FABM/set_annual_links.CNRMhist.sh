...
ln -sf $INDIR_RIVERS/CNRM_hist_river_BGC_y${yn}.nc ${RUNPATH}/RIVERS/river_BGC_y${yn}.nc
ln -sf $INDIR_RIVERS/CNRM_hist_river_BGC_y${ya}.nc ${RUNPATH}/RIVERS/river_BGC_y${ya}.nc
ln -sf $INDIR_RIVERS/CNRM_hist_river_BGC_y${yb}.nc ${RUNPATH}/RIVERS/river_BGC_y${yb}.nc
ln -sf $INDIR_RIVERS/runoff_socoefr_v2.nc  ${RUNPATH}/RIVERS/runoff_socoefr_v2.nc
