...
INDIR_RIVERS_hist=/work/n01/shared/yuti/se-ORCA025_CNRM_hist/
...
ln -sf $INDIR_RIVERS/CNRM_ssp370_river_BGC_y${yn}.nc ${RUNPATH}/RIVERS/river_BGC_y${yn}.nc
ln -sf $INDIR_RIVERS/CNRM_ssp370_river_BGC_y${ya}.nc ${RUNPATH}/RIVERS/river_BGC_y${ya}.nc
ln -sf $INDIR_RIVERS/CNRM_ssp370_river_BGC_y${yb}.nc ${RUNPATH}/RIVERS/river_BGC_y${yb}.nc
ln -sf $INDIR_RIVERS_hist/runoff_socoefr_v2.nc  ${RUNPATH}/RIVERS/runoff_socoefr_v2.nc
